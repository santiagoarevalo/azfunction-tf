...
resource "azurerm_windows_function_app" "azfunction" {
  name                = var.name_function
  resource_group_name = azurerm_resource_group.rg.name
  location            = azurerm_resource_group.rg.location
...
resource "azurerm_function_app_function" "azfaf" {
  name            = var.name_function
  function_app_id = azurerm_windows_function_app.azfunction.id
  language        = "Javascript"
